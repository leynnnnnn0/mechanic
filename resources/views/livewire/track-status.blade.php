<div>
    ...
    <section class="min-h-screen w-full flex flex-col items-center justify-center">
        <form wire:submit.prevent="getResult" class="relative flex items-center w-96 h-12 rounded-full border border-gray-200 focus-within:shadow-lg overflow-hidden">
